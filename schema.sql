...
INSERT INTO Activities (act, howto, category, createdAt, updatedAt) Values 
("Take-Downs", "1) Double Leg Takedown
If you grapple then you should be able to do at least a basic Double Leg.
This takedown is a mainstay in BJJ, Wrestling and MMA (unfortunately the 
Judo illuminati has completely banned it, to the detriment of the sport in my opinion).
You can’t use the Double Leg if you’re afraid of commitment: you have to hit it hard and fast.
But it’s also NOT just a football or a rugby tackle – this is a highly technical maneuver with 
sophisticated setups and follow-ups. There are lots of different variations for the Double Leg.  
The biggest differences between these variations include head position (is the head to the side 
or in the middle of the chest) and whether you drop down to your lead knee as you shoot (the 
penetration step). Many Freestyle Wrestlers use the penetration step because their opponents are 
usually quite bent over and they need to get as low as possible to hit this move.  In MMA it’s 
more common to stay up on the feet, but both variations are equally valid for BJJ.
...
", "Jiu Jitsu", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Escaping Dominant Position", "1)	The 4 Most Common Errors for The ‘Upa’ Mount Escape
...
The second escape is probably even simpler. The same basic defense principles apply, but now, instead of pinning the arms you’ll keep your arms tightly on your chest. You’ll use the Upa to create space and a frame. To do that, do the bridge, but leave your arms extended when you go back down. Now you have enough space to tuck your knees towards your chin. This will get your knees in between you and your opponent. Once you’re there, get both your arms to the triceps of their arms, near the armpits. At the same time, thread both knees on the biceps on each arm. Rock with your feet towards the mats and your opponent is going to fly right over.", "Jiu Jitsu", '2020-01-13 05:48:14','2020-01-13 05:48:14'),
("Submissions", "1)	Arm-Bar from the Mount
...
", "Jiu Jitsu", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Salsa", "All music has a beat or basic rhythm to it that can be counted. Music has a certain number of beats per measure, which is usually 3,4 or 6 beats. In salsa music, there are 2 measures with 4 beats per measure. The basic salsa dance step uses 8 beats. 
...
-Sit-ups
-Plank
", "Gym", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Pull", "Back
...
-Plank
", "Gym", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Calisthenics", "Do all the exercises in the order shown, resting 30 seconds between exercises and 3 minutes afterward. Repeat for 3 rounds.
...
", "Gym", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("IM Workout", "WarmUp: 100 Swim / 100 Kick / 100 Pull [300y]
...
", "Swimming", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Butterfly Workout", "WarmUp: 200 Free + 200 IM WarmUp
Set 1: (1,100y)
...
", "Swimming", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Breaststroke Workout", "200 Free + 200 IM WarmUp
...
", "Swimming", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Beginner", "Here are five poses to help you get started
...
", "Yoga", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Intermediate", "Here are three intermediate Yoga poses for you to practice.
1)	Boat Pose
...
", "Yoga", '2020-01-13 05:48:14', '2020-01-13 05:48:14'),
("Advanced", "Here are two Advanced poses for you to take yoga to the next level
1)	Firefly Pose
